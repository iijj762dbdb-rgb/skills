...
| 項目 | データ |
|:---|---:|
| 生成時刻 | 2026-05-26T03:10:56 |
| 集計ウィンドウ | 直近 7 日 |
| 集計開始時刻 (UTC) | 2026-05-18T18:10:56+00:00 |
| レコード数 | 70 |
...
| E1 索引サイズ - チャンク数 | 2383 |
| E2 索引鮮度 - 経過秒 | 0 |
| E2 索引鮮度 - DB mtime | 2026-05-26T03:10:56 |
| E5 孤児チャンク削除累計 (件) | 15 |
...
| 項目 | データ |
|:---|---:|
| A1 サブコマンド別呼び出し回数 | index=4, search=66 |
| A2 Step あたり呼び出し回数 (全 Workflow) | 6.09 |
| A2 総呼び出し回数 | 67 |
| A2 distinct Step 数 | 11 |
| A4 Skill _routing 記載 | はい |
| D1 DO NOT USE FOR 違反 (件) | 0 |
| D3 典型クエリ出現率 (合算) | 0 |
| D3 合算マッチ件数 | 0 |
| D3 合算 search 総件数 (patterns 定義済み workflow のみ) | 27 |
| D3 aad-web 出現率 | 0 |
| D3 aad-web マッチ件数 | 0 |
| D3 aad-web search 総件数 | 27 |
...
| 項目 | データ |
|:---|---:|
| B1 Context 削減率 | 0.9884 |
| B1 snippet 文字数合計 | 84263 |
| B1 参照元ファイル文字数合計 | 7248687 |
| B2 top_k 平均 | 5.61 |
| B2 max_tokens 平均 | 1184.85 |
...
| 項目 | データ |
|:---|---:|
| F1 search 実行時間 p50 (ms) | 293.5 |
| F1 search 実行時間 p95 (ms) | 1105 |
| F1 サンプルサイズ | 66 |
