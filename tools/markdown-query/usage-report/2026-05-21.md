...
| 項目 | データ |
|:---|---:|
| 生成時刻 | 2026-05-21T06:50:27 |
| 集計ウィンドウ | 直近 7 日 |
| 集計開始時刻 (UTC) | 2026-05-13T21:50:26+00:00 |
| レコード数 | 37 |
| Tokenize 言語 (表示中の DB) | ja-jp |
| Chunking Strategy (表示中の DB) | semantic_paragraph |
...
| E1 索引サイズ - チャンク数 | 5052 |
| E2 索引鮮度 - 経過秒 | 0 |
| E2 索引鮮度 - DB mtime | 2026-05-21T06:50:26 |
| E5 孤児チャンク削除累計 (件) | 50 |
...
| 項目 | データ |
|:---|---:|
| A1 サブコマンド別呼び出し回数 | index=3, search=32, stats=2 |
| A2 Step あたり呼び出し回数 (全 Workflow) | 3.44 |
| A2 総呼び出し回数 | 31 |
...
| 項目 | データ |
|:---|---:|
| B1 Context 削減率 | 0.9874 |
| B1 snippet 文字数合計 | 39846 |
| B1 参照元ファイル文字数合計 | 3159292 |
| B2 top_k 平均 | 5.25 |
| B2 max_tokens 平均 | 912.5 |
...
| 項目 | データ |
|:---|---:|
| F1 search 実行時間 p50 (ms) | 216 |
| F1 search 実行時間 p95 (ms) | 862.9 |
| F1 サンプルサイズ | 32 |
| G1 mdq 利用 Step 完了率差 | 0.2167 |
| G1 利用 run 平均 | 0.2167 |
| G1 未利用 run 平均 | 0 |
| G1 利用 run 数 | 3 |
| G1 未利用 run 数 | 3 |
| G1 mdq 利用 run_id 数 | 12 |
